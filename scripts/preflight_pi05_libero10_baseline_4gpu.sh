...
exp_name=${EXP_NAME:-pi05_libero10_baseline_4gpu_25step}
checkpoint_base_dir=${CHECKPOINT_BASE_DIR:-/workspace/vla/checkpoints/openpi_baseline_benchmark}
...
# Same hardware and batch semantics as the P1/P2 4-GPU preflight. This run
# disables auxiliary architecture/losses and does not save a large checkpoint.
